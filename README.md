# terraform-aws-kms-key [![Latest Release](https://img.shields.io/github/release/sevenpicocomponents/terraform-aws-kms-key.svg)](https://github.com/sevenpicocomponents/terraform-aws-kms-key/releases/latest)
...
```hcl
module "kms_key" {
  source = "sevenpicocomponents/kms-key/aws"
